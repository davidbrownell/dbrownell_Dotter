...
class TestInstall:
    ...
    def test_basic_invocation(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            # Verify InstallEntries was called with correct kwargs
    ...
    def test_force_option(self, tmp_path: Path) -> None:
        """Test that --force option is passed to InstallEntries."""
    ...
    def test_dry_run_option(self, tmp_path: Path) -> None:
        """Test that --dry-run option is passed to InstallEntries."""
    ...
    def test_var_option_multiple(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            result = runner.invoke(
                app,
                ["Install", str(config_file), "--var", "key1=value1", "--var", "key2=value2"],
            )
    ...
    def test_var_option_with_equals_in_value(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            result = runner.invoke(
                app,
                ["Install", str(config_file), "--var", "equation=a=b+c"],
            )
    ...
    def test_var_option_invalid_format(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            result = runner.invoke(app, ["Install", str(config_file), "--var", "invalid"])
    ...
    def test_entries_passed_to_process(self, tmp_path: Path) -> None:
        """Test that entries from ResolveEntries are passed to InstallEntries."""
        ...
        with (
            ...
            # Verify the entries were passed to InstallEntries
    ...
    def test_nonexistent_config_file(self, tmp_path: Path) -> None:
        ...
        result = runner.invoke(app, ["Install", str(nonexistent)])
...
class TestReverseSync:
    # ----------------------------------------------------------------------
    def test_no_args_shows_help(self) -> None:
        """Test that running ReverseSync with no args shows help/usage."""

        result = runner.invoke(app, ["ReverseSync"])
    ...
    def test_basic_invocation(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            assert result.exit_code == 0
            mock_resolve.assert_called_once()
            mock_reverse_sync.assert_called_once()
            ...
            # Verify ReverseSyncEntries was called with correct kwargs
            reverse_sync_kwargs = mock_reverse_sync.call_args[1]
            assert reverse_sync_kwargs["dry_run"] is False
    ...
    # ----------------------------------------------------------------------
    def test_dry_run_option(self, tmp_path: Path) -> None:
        """Test that --dry-run option is passed to ReverseSyncEntries."""
    ...
    def test_var_option_single(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            # Verify template_vars dict is passed to ReverseSyncEntries
            reverse_sync_args = mock_reverse_sync.call_args[0]
            assert reverse_sync_args[2] == {"name": "value"}
    ...
    def test_var_option_multiple(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            result = runner.invoke(
                app,
                ["ReverseSync", str(config_file), "--var", "key1=value1", "--var", "key2=value2"],
            )
            ...
            # Verify template_vars dict is passed to ReverseSyncEntries
            reverse_sync_args = mock_reverse_sync.call_args[0]
            assert reverse_sync_args[2] == {"key1": "value1", "key2": "value2"}
    ...
    def test_var_option_with_equals_in_value(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            result = runner.invoke(
                app,
                ["ReverseSync", str(config_file), "--var", "equation=a=b+c"],
            )
            ...
            # Verify template_vars dict is passed to ReverseSyncEntries
            reverse_sync_args = mock_reverse_sync.call_args[0]
            assert reverse_sync_args[2] == {"equation": "a=b+c"}
    ...
    def test_var_option_invalid_format(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            result = runner.invoke(app, ["ReverseSync", str(config_file), "--var", "invalid"])

            assert result.exit_code != 0
            assert "must be in the form key=value" in result.output

    # ----------------------------------------------------------------------
    def test_entries_passed_to_reverse_sync(self, tmp_path: Path) -> None:
        """Test that entries from ResolveEntries are passed to ReverseSyncEntries."""
        ...
        with (
            ...
            # Verify the entries were passed to ReverseSyncEntries
            reverse_sync_args = mock_reverse_sync.call_args[0]
            assert reverse_sync_args[1] == mock_entries
    ...
    def test_nonexistent_config_file(self, tmp_path: Path) -> None:
        ...
        result = runner.invoke(app, ["ReverseSync", str(nonexistent)])
    ...
    def test_var_option_empty_value(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            # Verify template_vars dict is passed to ReverseSyncEntries
            reverse_sync_args = mock_reverse_sync.call_args[0]
            assert reverse_sync_args[2] == {"empty": ""}

    # ----------------------------------------------------------------------
    def test_no_force_option(self, tmp_path: Path) -> None:
        """Test that ReverseSync does not have a --force option."""

        config_file = tmp_path / "config.yaml"
        config_file.write_text("variable_definitions: {}\nentries: []", encoding="utf-8")

        result = runner.invoke(app, ["ReverseSync", str(config_file), "--force"])
